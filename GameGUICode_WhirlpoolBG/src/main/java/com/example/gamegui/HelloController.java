...
public class HelloController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Going through the process of adding a background
        Image whirlpool = new Image("Whirlpool.jpg");
        BackgroundImage wp_galaxy = new BackgroundImage(
                whirlpool,
        ...
        Background wp_bg = new Background(wp_galaxy);
        root.setBackground(wp_bg);
