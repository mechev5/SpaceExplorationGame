...
public class Kep90b implements Initializable {
    @FXML
    BorderPane root;
    @FXML
    ImageView kepX;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        Image k = new Image(this.getClass().getResource("planetImages/Kepler-90b.png").toExternalForm());
