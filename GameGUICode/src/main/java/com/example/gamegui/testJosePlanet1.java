...
public class testJosePlanet1 implements Initializable {
    @FXML
    BorderPane root;
    //    @FXML
//    private TextArea infoTextArea;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Image Andro = new Image(getClass().getResource("images/Square1.jpg").toExternalForm());
